...
<div class="wrapper real-estate">
    ...
    <div class="banner text-center">
        <div class="vertical-align">
            <h1 class="white"><span class="bold">Edificios</span></h1>
        </div>
    </div>
    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
            ...
            <div class="row no-margin">
                <div class="col-sm-12 city-nav">
                    <ul class="nav tabs">
                        ...
                        <li class="active"><a href="#0" data-toggle="tab">Todos los Proyectos</a></li>
                        <li><a class="vertical-align" href="#1" data-toggle="tab">Chihuahua</a></li>
                        <li><a class="vertical-align" href="#2" data-toggle="tab">Juárez</a></li>
                        <li><a class="vertical-align" href="#3" data-toggle="tab">Monterrey</a></li>
                        <li><a class="vertical-align" href="#4" data-toggle="tab">Guadalajara</a></li>
                        <li><a class="vertical-align" href="#5" data-toggle="tab">Querétaro</a></li>
                    </ul>
                </div>
                <div class="row no-margin">
    ...
    <div class="suit" id="suit">
        ...
        <div class="container spacing">
            <div class="text-center">
                <h1 class="blue header text-center">Edificios hechos a la medida</h1>
            </div>
