        <footer>
            ...
            <div class="footer-rights">
                <p class="white text-center">Todos los derechos reservados Bafar Real Estate <?php echo date('Y'); ?> | Design by: <a href="http://mixen.mx"><img src="http://mixen.mx/firma/logo-mixen.png" alt="Agencia Mixen"> mixen.mx</a></p>
            </div>
        </footer>
